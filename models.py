...
class Photo(Base):
    ...
    matches_as_b = relationship("Match", foreign_keys="[Match.photo_b_id]", back_populates="photo_b")
...
class Match(Base):
    ...
    photo_b = relationship("Photo", foreign_keys=[photo_b_id], back_populates="matches_as_b")
    winner = relationship("Photo", foreign_keys=[winner_id], back_populates="matches_won")
