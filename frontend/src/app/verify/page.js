      ...
      <div className="glass-panel" style={{ padding: "3rem", textAlign: "center", maxWidth: "500px" }}>
        ...
        {status === "success" && (
          <>
            ...
            <p>Your account has been successfully activated. You will be redirected to the login page shortly.</p>
          </>
        )}

        {status === "error" && (
          <>
            <h2 style={{ color: "#ff4b4b", marginBottom: "1rem" }}>Verification Failed</h2>
